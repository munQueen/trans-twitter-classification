...
#fetch tweets from a given user
twitter_handle = "marlow_f"
query_term = "from:" + twitter_handle
tweets = query_tweets(query=query_term, begindate=datetime.date(2018, 1, 1), enddate=datetime.date(2019, 10, 1), limit=2000, lang='en')
